 ...
 * calling the model, the first message of a conversation when it is not about
 * the school's own records (general knowledge, weather, coding...), and any
 * message probing how the system is built (schema, SQL, prompts). It is a
 * first line of defence; the assistant's instructions repeat the same limits
 * for everything that gets through, including follow-ups.
 */
class TopicGuard
{
