...
/**
 * The topic guard for the ministry's assistant: same probing defence and the
 * same product vocabulary, but the data domain is the whole school system
 * rather than one school.
 */
class MinistryTopicGuard extends TopicGuard
{
    public const REFUSAL = 'I can only help with questions about schools in the system: their students, teachers, classes, attendance and grades, or with finding your way around the portal. '
        .'For example: "Which schools are understaffed?" or "Where do I send an announcement?"';
